...
public class ApiParam {
    ...
    public static final String ASK_A_QUESTION = "http://bihu.jay86.com/question.php";
    public static final String GET_QUESTION_LIST = "http://bihu.jay86.com/getQuestionList.php";
    ...
    public static final String MY_QINIU_URL = "http://p4qs1um1f.bkt.clouddn.com/";//后面拼接文件名
}
